...
namespace API_Baixa_Sapiens.Controllers
{
    ...
    public class ExcelController : ControllerBase
    {
            ...
            try
            {
                ...
                using (var arquivoScript = new StreamWriter(arquivoScriptPath))
                {
                    arquivoScript.WriteLine("USE BD_COBRANCA\r\n\r\n\r\nSET DATEFORMAT YMD\r\n\r\nDECLARE @qtdAutos\t\t\t\t\tINT,\r\n\t\t@NR_AUTO_INFRACAO\t\t\tVARCHAR(20)," +
                        ...
                        "\r\n\tDROP TABLE #TBL_TEMP_AUTOS_BAIXA_MANUAL\r\n\r\nCREATE TABLE #TBL_TEMP_AUTOS_BAIXA_MANUAL(Id INT IDENTITY(1, 1), CPF_CNPJ VARCHAR(20)," +
                        " NR_AUTO_INFRACAO VARCHAR(20), CO_CHAVE_DOCUMENTO_ORIGEM VARCHAR(20), DT_PAGAMENTO DATETIME, VL_PAGAMENTO NUMERIC(13,2)) \r\n\r\n");
                    ...
                    arquivoScript.WriteLine("\r\nSELECT DISTINCT\r\n\tCASE \r\n\t\tWHEN TD.CO_CHAVE_DOCUMENTO_ORIGEM IS NOT NULL THEN\r\n\t\t\t'AUTO BAIXADO NO ARRECADAÇÃO" +
                        ...
                        "\r\n\t\t\t\t#TBL_TEMP_AUTOS_BAIXA_MANUAL\tTABM\r\n\tLEFT JOIN\tBD_COBRANCA.DBO.TBL_DOCUMENTO\tTD\t\tWITH(NOLOCK) ON " +
                        "(\t(TD.CO_CHAVE_DOCUMENTO_ORIGEM COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS  = TABM.CO_CHAVE_DOCUMENTO_ORIGEM COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS " +
                        ...
                        "\r\n\t\t\t\t\t\t#TBL_TEMP_AUTOS_BAIXA_MANUAL\tTABM\r\n\t\t\tINNER JOIN\tBD_COBRANCA.DBO.TBL_DOCUMENTO\tTD\t\tWITH(NOLOCK) ON (\t(TD.CO_CHAVE_DOCUMENTO_ORIGEM " +
                        "COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS  = TABM.CO_CHAVE_DOCUMENTO_ORIGEM COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS \r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tOR " +
                        "TD.NR_AUTO_INFRACAO COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS = TABM.NR_AUTO_INFRACAO COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tOR " +
                        "TD.CO_CHAVE_DOCUMENTO_ORIGEM COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS = TABM.NR_AUTO_INFRACAO COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS)   \r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t" +
                        "AND (TD.NR_CNPJ_AUTUADO COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS  = TABM.CPF_CNPJ COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS  \r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t" +
                        "OR TD.NR_CPF_AUTUADO COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS  = TABM.CPF_CNPJ COLLATE SQL_LATIN1_GENERAL_CP1_CI_AS ))\r\n\t\tWHERE \r\n\t\t\tID = @QTDAUTOS \r\n\r\n\t\t" +
                        "SELECT \r\n\t\t\t@SQ_DOCUMENTO\t\t= TD.SQ_DOCUMENTO,\r\n\t\t\t@NR_ORDEM_DOC_ENVIO = (SELECT MAX(NR_ORDEM_DOCUMENTO_ENVIO) FROM BD_COBRANCA.DBO.TBL_DOCUMENTO_ENVIO WITH(NOLOCK) " +
                        "WHERE SQ_DOCUMENTO = TD.SQ_DOCUMENTO)\r\n\t\tFROM\t\r\n\t\t\tBD_COBRANCA.DBO.TBL_DOCUMENTO\t\tTD\tWITH(NOLOCK) \r\n\t\tWHERE \r\n\t\t\t\tCO_CHAVE_DOCUMENTO_ORIGEM = @CO_CHAVE_ORIGEM " +
                        "\r\n\t\t\tAND SQ_FASE_DOCUMENTO = (\tSELECT MAX(SQ_FASE_DOCUMENTO) \r\n\t\t\t\t\t\t\t\t\t\tFROM BD_COBRANCA.DBO.TBL_DOCUMENTO WITH(NOLOCK) \r\n\t\t\t\t\t\t\t\t\t\t" +
                        "WHERE \r\n\t\t\t\t\t\t\t\t\t\t\t\tCO_CHAVE_DOCUMENTO_ORIGEM = @CO_CHAVE_ORIGEM \r\n\t\t\t\t\t\t\t\t\t\t\tAND SQ_FASE_DOCUMENTO <> 12\r\n\t\t\t\t\t\t\t\t\t)\r\n\r\n\t\tIF\t\t" +
                        "(@NR_AUTO_INFRACAO = '1833338' AND @CO_CHAVE_ORIGEM <> '1348606')\r\n\t\t\tOR  (@NR_AUTO_INFRACAO = '2438153' AND @CO_CHAVE_ORIGEM <> '1501827')\r\n\t\t\tBEGIN\r\n\t\t\t\t" +
                        "SET @NR_AUTO_INFRACAO\t\t= NULL\t\t\r\n\t\t\t\tSET @CO_CHAVE_ORIGEM\t\t= NULL\t\t\r\n\t\t\t\tSET @DT_PAGAMENTO\t\t\t= NULL\r\n\t\t\t\tSET @VL_PAGAMENTO\t\t\t= NULL\r\n\t\t\t\t" +
                        "SET @SQ_DOCUMENTO\t\t\t= NULL\r\n\t\t\t\tSET @NR_ORDEM_DOC_ENVIO\t\t= NULL\r\n\t\t\tEND\r\n\r\n\r\n\t\tPRINT 'EXECUÇÃO DE BAIXA MANUAL PARA O AI: ' + @NR_AUTO_INFRACAO + " +
                        "' - CO_CHAVE_DOCUMENTO_ORIGEM: ' + @CO_CHAVE_ORIGEM + ' - DT_PAGAMENTO: ' + CAST(@DT_PAGAMENTO AS VARCHAR(20)) + ' - VL_PAGAMENTO: ' + CAST(@VL_PAGAMENTO AS VARCHAR(20))\r\n\r\n\t\tIF " +
                        ...
                        "ID_TP_QUITACAO IN (26, 25)\r\n\t\t\t\t\t\t)\r\n\t\t\tBEGIN\t\t\t\t\t\t\t\t\t\r\n\t\t\t\tIF NOT EXISTS (\tSELECT 1\r\n\t\t\t\t\t\t\t\tFROM\t\r\n\t\t\t\t\t\t\t\t\t" +
                        "BD_COBRANCA.DBO.TBL_FINANCEIRA\tTF WITH(NOLOCK) \r\n\t\t\t\t\t\t\t\tWHERE\r\n\t\t\t\t\t\t\t\t\t\tSQ_DOCUMENTO = @SQ_DOCUMENTO\r\n\t\t\t\t\t\t\t\t\tAND NR_ORDEM_DOCUMENTO_ENVIO =" +
                        ...
                        "\r\n\t\t\t\t\t\t\tBEGIN\r\n\r\n\t\t\t\t\t\t\t\tPRINT 'É UM AI DO SISMULTAS'\r\n\r\n\t\t\t\t\t\t\t\tIF EXISTS (SELECT 1 FROM BD_MULTAS.DBO.TBLDOCUMENTO WITH(NOLOCK) " +
                        "WHERE CAST(IDDOCUMENTO AS VARCHAR(20)) = @CO_CHAVE_ORIGEM AND IDSITUACAO <> 14)\r\n\t\t\t\t\t\t\t\t\tBEGIN\r\n\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t\t" +
                        "BEGIN TRANSACTION\r\n\r\n\t\t\t\t\t\t\t\t\t\t\tUPDATE BD_MULTAS.DBO.TBLDOCUMENTO\r\n\t\t\t\t\t\t\t\t\t\t\tSET IDSITUACAO = 14 \r\n\t\t\t\t\t\t\t\t\t\t\tWHERE \r\n\t\t\t\t\t\t\t\t\t\t\t\t" +
                        "CAST(IDDOCUMENTO AS VARCHAR(20)) = @CO_CHAVE_ORIGEM\r\n\t\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t\tIF @@ERROR <> 0\r\n\t\t\t\t\t\t\t\t\t\t\tBEGIN\r\n\t\t\t\t\t\t\t\t\t\t\t\tPRINT " +
                        "'ERRO AO TENTAR FAZER UPDATE DE QUITAÇÃO NA TABELA DOCUMENTO DO MULTAS!!'\r\n\t\t\t\t\t\t\t\t\t\t\t\tROLLBACK\r\n\t\t\t\t\t\t\t\t\t\t\tEND\r\n\t\t\t\t\t\t\t\t\t\tELSE\r\n\t\t\t\t\t\t\t\t\t\t\t" +
                        ...
                        "AND IDDOCUMENTOSITUACAOAUDITORIA = (SELECT MAX(IDDOCUMENTOSITUACAOAUDITORIA) FROM BD_MULTAS.DBO.TBLDOCUMENTOSITUACAOAUDITORIA WITH(NOLOCK) WHERE CAST(IDDOCUMENTO AS VARCHAR(20)) = " +
                        " @CO_CHAVE_ORIGEM)\r\n\r\n\t\t\t\t\t\t\t\t\t\tBEGIN TRANSACTION\r\n\r\n\t\t\t\t\t\t\t\t\t\t\tINSERT INTO BD_MULTAS.DBO.TBLDOCUMENTOSITUACAOAUDITORIA\r\n\t\t\t\t\t\t\t\t\t\t\tVALUES(GETDATE(), " +
                        "@CO_CHAVE_ORIGEM, 7707, @IDSITUACAOANTERIOR_MULTAS, 14, NULL) \r\n\r\n\t\t\t\t\t\t\t\t\t\t\t\t\r\n\r\n\t\t\t\t\t\t\t\t\t\tIF @@ERROR <> 0\r\n\t\t\t\t\t\t\t\t\t\t\tBEGIN\r\n\t\t\t\t\t\t\t\t\t\t\t\t" +
                        ...
                        "END \r\n\r\n\t\t\t\t\t\t\t\t\tEND\r\n\t\t\t\t\r\n\t\t\t\t\t\t\t\tIF EXISTS (SELECT 1 FROM BD_MULTAS.DBO.TBLDOCUMENTOSITUACAO WITH(NOLOCK) WHERE CAST(IDDOCUMENTO AS VARCHAR(20)) = @CO_CHAVE_ORIGEM " +
                        ...
                        "ROLLBACK\r\n\t\t\t\t\t\t\t\t\t\t\tEND\r\n\t\t\t\t\t\t\t\t\t\tELSE\r\n\t\t\t\t\t\t\t\t\t\t\tBEGIN\r\n\t\t\t\t\t\t\t\t\t\t\t\tPRINT 'EXECUTOU O UPDATE DA DATA DE PAGAMENTO DA TABELA TBLDOCUMENTOSITUACAO DO " +
                        ...
                        "\r\n\t\t\t\t\t\t\t\tSQ_DOCUMENTO,\r\n\t\t\t\t\t\t\t\tNR_ORDEM_DOCUMENTO_ENVIO,\r\n\t\t\t\t\t\t\t\tNULL,\r\n\t\t\t\t\t\t\t\tNULL,\r\n\t\t\t\t\t\t\t\t'AI BAIXADO ATRAVÉS DE ROTINA EM BANCO DE DADOS CONFORME " +
                        "SOLICITADO ATRAVÉS DOS SICAD 37.843.',\r\n\t\t\t\t\t\t\t\t0,\r\n\t\t\t\t\t\t\t\tVL_DOCUMENTO_DOLAR,\r\n\t\t\t\t\t\t\t\tVL_INDICE_PTAX,\r\n\t\t\t\t\t\t\t\tDA_INICIO_SELIC,\r\n\t\t\t\t\t\t\t\tDA_FIM_SELIC," +
                        ...
                        "@SQ_DOCUMENTO\r\n\t\t\t\t\t\t\t\tAND NR_ORDEM_DOCUMENTO_ENVIO = @NR_ORDEM_DOC_ENVIO\r\n\t\t\t\t\t\t\t\tAND NR_ORDEM_FINANCEIRA = (SELECT MAX(NR_ORDEM_FINANCEIRA) FROM BD_COBRANCA.DBO.TBL_FINANCEIRA WITH(NOLOCK) " +
                        "WHERE SQ_DOCUMENTO = @SQ_DOCUMENTO AND NR_ORDEM_DOCUMENTO_ENVIO = @NR_ORDEM_DOC_ENVIO)\r\n\t\t\t\t\r\n\t\t\t\t\t\tIF @@ERROR <> 0\r\n\t\t\t\t\t\t\tBEGIN\r\n\t\t\t\t\t\t\t\tPRINT 'ERRO AO TENTAR FAZER UPDATE NA " +
                        "TABELA FINANCEIRA DO COBRANCA!!'\r\n\t\t\t\t\t\t\t\tROLLBACK\r\n\t\t\t\t\t\t\tEND\r\n\t\t\t\t\t\tELSE\r\n\t\t\t\t\t\t\tBEGIN\r\n\t\t\t\t\t\t\t\tPRINT 'EXECUTOU O UPDATE NA TABELA FINANCEIRA DO COBRANCA.'\r\n\t\t\t\t\t\t\t\t" +
                        "COMMIT\r\n\t\t\t\t\t\t\tEND \r\n\r\n\t\t\t\t\t\tBEGIN TRANSACTION\r\n\r\n\t\t\t\t\t\t\tUPDATE BD_COBRANCA.DBO.TBL_DOCUMENTO_ENVIO\r\n\t\t\t\t\t\t\tSET ST_DOCUMENTO = 'P'\r\n\t\t\t\t\t\t\tWHERE \r\n\t\t\t\t\t\t\t\t\t" +
                        "SQ_DOCUMENTO = @SQ_DOCUMENTO\r\n\t\t\t\t\t\t\t\tAND NR_ORDEM_DOCUMENTO_ENVIO = @NR_ORDEM_DOC_ENVIO\r\n\t\t\t\t\r\n\t\t\t\t\t\tIF @@ERROR <> 0\r\n\t\t\t\t\t\t\tBEGIN\r\n\t\t\t\t\t\t\t\t" +
                        "PRINT 'ERRO AO TENTAR FAZER UPDATE NA TABELA DOCUMENTO ENVIO DO COBRANCA!!'\r\n\t\t\t\t\t\t\t\tROLLBACK\r\n\t\t\t\t\t\t\tEND\r\n\t\t\t\t\t\tELSE\r\n\t\t\t\t\t\t\tBEGIN\r\n\t\t\t\t\t\t\t\tPRINT 'EXECUTOU O UPDATE NA TABELA DOCUMENTO ENVIO DO COBRANCA.'" +
                        "\r\n\t\t\t\t\t\t\t\tCOMMIT\r\n\t\t\t\t\t\t\tEND \r\n\r\n\r\n\t\t\t\t\t\tIF EXISTS (SELECT 1 FROM BD_MULTAS.DBO.TBLDOCUMENTO WITH(NOLOCK) WHERE CAST(IDDOCUMENTO AS VARCHAR(20)) = @CO_CHAVE_ORIGEM)\r\n\t\t\t\t\t\t\tBEGIN\r\n\r\n\t\t\t\t\t\t\t\t" +
                        ...
                        "BEGIN TRANSACTION\r\n\r\n\t\t\t\t\t\t\t\t\t\t\tUPDATE BD_MULTAS.DBO.TBLDOCUMENTO\r\n\t\t\t\t\t\t\t\t\t\t\tSET IDSITUACAO = 14 \r\n\t\t\t\t\t\t\t\t\t\t\tWHERE \r\n\t\t\t\t\t\t\t\t\t\t\t\tCAST(IDDOCUMENTO AS VARCHAR(20)) = " +
        ...
        {
            string connectionString = "Data Source=ANTTSQLDEV01;Database=BD_COBRANCA;Trusted_Connection=True;";
        ...
        [HttpPost("ExibirResultadoScript")]
        private IActionResult ExibirResultadoScript(string scriptFilePath)
        {
            string connectionString = "Data Source=ANTTSQLDEV01;Database=BD_COBRANCA;Trusted_Connection=True;";
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                // Aqui você pode obter os valores das colunas do SqlDataReader
                                // e exibi-los na tela ou fazer qualquer outra manipulação desejada.
                                // Por exemplo, para exibir o valor de uma coluna chamada "nome" em cada linha:
