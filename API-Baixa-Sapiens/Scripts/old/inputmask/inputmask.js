...
!function(factory) {
    "function" == typeof define && define.amd
        ...
        ? module.exports =
        factory(require("./dependencyLibs/inputmask.dependencyLib"),
    ...
    function maskScope(actionObj, maskset, opts) {
            ...
            for (var testPos,
                ...
                (testPos = testPositions[ndx],
                    !(testPos.match &&
                        ...
                        !0 === guessNextBest && (null !== testPos.match.fn || /[0-9a-bA-Z]/.test(testPos.match.def)));
                ndx++);
            return testPos;
        }
                ...
                function handleMatch(match, loopNdx, quantifierRecurse) {
                    ...
                    if (match.matches !== undefined) {
                        if (match.isGroup && quantifierRecurse !== match) {
                            if (match =
                                handleMatch(maskToken.matches[$.inArray(match, maskToken.matches) + 1], loopNdx))
                                return !0;
                        } else if (match.isOptional) {
                            var optionalToken = match;
                            if (match = resolveTestFromToken(match, ndxInitializer, loopNdx, quantifierRecurse)) {
                                if (latestMatch =
                                    matches[matches.length - 1].match, !isFirstMatch(latestMatch, optionalToken))
                                    return !0;
                            ...
                            if (-1 === altIndex || "string" == typeof altIndex) {
                                    ...
                                    if (amndx = parseInt(altIndexArr[ndx]), matches = [], ndxInitializer =
                                        ...
                                        !0 !==
                                            (match = handleMatch(
                                                ...
                                                match) &&
                                            match !== undefined &&
                                            altIndexArr[altIndexArr.length - 1] < alternateToken.matches.length) {
                                            ...
                                            if ("string" != typeof altIndex ||
                                                ...
                                                if (function(source, target) {
                                                    ...
                                                    altMatch.alternation == altMatch2.alternation &&
                                                        ...
                                                        .indexOf(altMatch2.locator[altMatch2.alternation].toString()
                                                            .split("")[0]) &&
                                                        (altMatch.na = altMatch.na ||
                                                            ...
                                                            -1 ===
                                                                ...
                                                                (altMatch.na = altMatch.na +
                                                                    "," +
                                                                    altMatch.locator[altMatch2.alternation].toString()
                                                                    .split("")[0]),
                                                            dropMatch = !0, altMatch.locator[altMatch.alternation] =
                                                                altMatch2.locator[altMatch2.alternation].toString()
                                                                .split("")[0] +
                                                                "," +
                                                                altMatch.locator[altMatch.alternation],
                                ...
                                match = handleMatch(alternateToken.matches[altIndex] || maskToken.matches[altIndex],
        ...
        function refreshFromBuffer(start, end, buffer) {
            ...
            for (p = start, i = start; i < end; i++)
                if (resetMaskSet(!0), buffer[i] !== opts.skipOptionalPartCharacter) {
                    ...
                    !1 !== valResult &&
                        (resetMaskSet(!0), p = valResult.caret !== undefined ? valResult.caret : valResult.pos + 1);
                }
        }
        ...
        function casing(elem, test, pos) {
            ...
            case "title":
                ...
                elem = 0 === pos || posBefore && posBefore.input === String.fromCharCode(Inputmask.keyCode.SPACE)
                    ? elem.toUpperCase()
                    : elem.toLowerCase();
                break;
        ...
        function isValid(pos, c, strict, fromSetValid, fromAlternate) {
                        ...
                        (rslt = null != test.fn
                            ...
                            ($.isArray(rslt.insert) || (rslt.insert = [rslt.insert]),
                                ...
                                (validatedPos = rslt.pos,
                                    refreshFromBuffer(position, validatedPos, getBuffer().slice()), validatedPos !==
                                        position))
            ...
            function setValidPosition(pos, validTest, fromSetValid, isSelection) {
                if (isSelection ||
                    opts.insertMode && getMaskSet().validPositions[pos] !== undefined && fromSetValid === undefined) {
                    var i,
                        positionsClone = $.extend(!0, {}, getMaskSet().validPositions),
                    ...
                    for (i = j = pos; i <= lvp; i++) {
                        ...
                        if (t !== undefined)
                            for (var posMatch = j;
                                ...
                                (null === t.match.fn &&
                                    vps[i] &&
                                    (!0 === vps[i].match.optionalQuantifier || !0 === vps[i].match.optionality) ||
                                    null != t.match.fn);
                            ) {
                                if (posMatch++, !1 === needsValidation &&
                                    ...
                                    valid = !1 !== result, j =
                                            result.caret || result.insert ? getLastValidPosition() : posMatch,
                                        needsValidation = !0;
                                            ...
                                            for (var targetLocator = vp.locator,
                                                ...
                                                if (getMaskSet().validPositions[ps] === undefined && !isMask(ps, !0)) {
                                                    var tests = getTests(ps).slice(),
                                                        ...
                                                        equality = -1;
                                                    "" === tests[tests.length - 1].match.def && tests.pop(), $.each(
                                                            tests,
                                                            function(ndx, tst) {
                                                                for (var i = 0; i < tll; i++) {
                                                            ...
                                                            bestMatch,
                                                            {
                                                                input: getPlaceholder(ps, bestMatch.match, !0) ||
                                                                    bestMatch.match.def
                                                            }), bestMatch.generatedInput =
                                                            !0, setValidPosition(ps, bestMatch, !0), getMaskSet()
                                                            .validPositions[newPos] = undefined,
                ...
                !1 === result &&
                    ...
                    (result = function(pos, c, strict) {
                        ...
                        if (alternation !== undefined) {
                            ...
                            var decisionTaker = prevAltPos.locator[prevAltPos.alternation || alternation] !== undefined
                                ? prevAltPos.locator[prevAltPos.alternation || alternation]
                                : altNdxs[0];
                            decisionTaker.length > 0 && (decisionTaker = decisionTaker.split(",")[0]);
                            var possibilityPos = getMaskSet().validPositions[decisionPos],
                                prevPos = getMaskSet().validPositions[decisionPos - 1];
                            $.each(getTests(decisionPos, prevPos ? prevPos.locator : undefined, decisionPos - 1),
                                function(ndx, test) {
                                        ...
                                        (test.na === undefined ||
                                            ...
                                            for (getMaskSet().validPositions[decisionPos].locator[alternation] =
                                                ...
                                                null == test.match.fn
                                                    ? (possibilityPos.input !== test.match.def &&
                                                        ...
                                                        getMaskSet().validPositions[decisionPos].generatedInput =
                                            ...
                                            for (verifyValidInput &&
                                                ...
                                                if (input !== opts.skipOptionalPartCharacter &&
                                                    !(isValidRslt = isValid(getLastValidPosition(undefined, !0) + 1,
                                                        input,
                                                        !1,
                                                        fromSetValid,
                                                        !0))) break;
                                            ...
                                            if (isValidRslt) {
                                                ...
                                                for (i = decisionPos + 1; i < getLastValidPosition() + 1; i++)
                                                    ((validPos = getMaskSet().validPositions[i]) === undefined ||
                                                ...
                                                pos += staticInputsBeforePosAlternate - staticInputsBeforePos,
                                                    isValidRslt =
                                                        isValid(pos > targetLvp ? targetLvp : pos,
                                                            c,
                                                            strict,
                                                            fromSetValid,
                                                            !0);
                        ...
                        for (var i = 0; i < tests.length; i++)
                            if (!0 !== tests[i].match.optionality &&
                                ...
                                (null === tests[i].match.fn ||
                                    prevTest === undefined ||
                                    !1 !== tests[i].match.fn.test(prevTest.match.def, getMaskSet(), pos, !0, opts)) &&
                ...
                function(ndx, charCode) {
                    if (charCode !== undefined) {
                        ...
                        if (!isTemplateMatch(initialNdx, charCodes) || strict || opts.autoUnmask) {
                            var pos = strict
                                ? ndx
                                : null == nextTest.match.fn && nextTest.match.optionality && lvp + 1 < getMaskSet().p
                                ? lvp + 1
                                : getMaskSet().p;
            ...
            for (var validPos,
                ...
                rl < bl &&
                    ...
                    (!0 !== validPos.match.optionalQuantifier && !0 !== validPos.match.newBlockMarker ||
                        rl + 1 === bl &&
                        "" ===
                        (lv !== undefined ? getTestTemplate(rl + 1, lv.locator.slice(""), lv) : getTest(rl + 1)).match
                        .def);
            ) rl++;
            for (;
                            ...
                            for (var validInputs = [],
                                ...
                                if (altPos) {
                                    if (!0 !== altPos.generatedInput &&
                                        ...
                                        delete getMaskSet().validPositions[lastAlt], altPos.alternation !== undefined &&
        ...
        function initializeColorMask(input) {
            ...
            function position() {
                colorMask.style.position = "absolute", colorMask.style.top = offset.top + "px",
                    colorMask.style.left = offset.left + "px", colorMask.style.width = parseInt(input.offsetWidth) -
            ...
            input.style.backgroundColor = "transparent", input.style.color = "transparent",
                input.style.webkitAppearance = "caret", input.style.mozAppearance = "caret", input.style.Appearance =
                    "caret",
        ...
        var undoValue,
            ...
            EventHandlers = {
                keydownEvent: function(e) {
                    ...
                    if (k === Inputmask.keyCode.BACKSPACE ||
                        ...
                        !function(eventName) {
                            ...
                            return isSupported ||
                                    (el.setAttribute(evName, "return;"), isSupported = "function" == typeof el[evName]),
                                el = null, isSupported;
                        }("cut"))
                        ...
                        k === Inputmask.keyCode.HOME && !e.shiftKey || k === Inputmask.keyCode.PAGE_UP
                            ...
                            ? (!0 === e.shiftKey
                                    ? (null === getTest(pos.begin).match.fn && (pos.begin = seekNext(pos.begin)),
                                        pos.end = seekPrevious(pos.begin, !0), pos.begin = seekPrevious(pos.end, !0))
                            ...
                            : (opts.insertMode = !opts.insertMode, caret(input,
                                opts.insertMode || pos.begin !== getMaskSet().maskLength ? pos.begin : pos.begin - 1));
                ...
                pasteEvent: function(e) {
                    ...
                    if (valueBeforeCaret ===
                            (isRTL ? getBufferTemplate().reverse() : getBufferTemplate()).slice(0, caretPos.begin)
                            .join("") &&
                            (valueBeforeCaret = ""),
                        valueAfterCaret ===
                ...
                inputFallBackEvent: function(e) {
                    ...
                    if (getBuffer().join("") !== inputValue) {
                        ...
                        if (inputValue =
                                inputValue.replace(
                                    new RegExp("(" + Inputmask.escapeRegex(getBufferTemplate().join("")) + ")*"),
                                    ""),
                            iemobile) {
                            var inputChar = inputValue.replace(getBuffer().join(""), "");
                            if (1 === inputChar.length) {
                                var keypress = new $.Event("keypress");
                                return keypress.which = inputChar.charCodeAt(0), EventHandlers.keypressEvent.call(input,
                                        keypress,
                                        !0,
                                        !0,
                                        !1,
                        ...
                        if (caretPos.begin > inputValue.length &&
                            ...
                            inputValue = inputValue.replace(bufferTemplate, ""), $.isFunction(opts.onBeforeMask) &&
                                ...
                                checkVal(input, !0, !1, inputValue.split(""), e), function(input, frontPart, backPart) {
                                    ...
                                    if (0 === pos && targetPos !== frontPart.length) targetPos = frontPart.length;
                                    else {
                                        for (; null === currentValue.match(Inputmask.escapeRegex(backPart) + "$");)
                                    ...
                                    isMask(targetPos) || (targetPos = seekNext(targetPos)), currentPos !== targetPos &&
            ...
            case "unmaskedvalue":
                return el !== undefined && actionObj.value === undefined ||
                    (valueBuffer = actionObj.value,
                        ...
                        $.isFunction(opts.onBeforeWrite) && opts.onBeforeWrite(undefined, getBuffer(), 0, opts)),
                    unmaskedvalue(el);
                ...
                !function(elem) {
                    ...
                    var isSupported = function(input, opts) {
                        var elementType = input.getAttribute("type"),
                            isSupported =
                                "INPUT" === input.tagName && -1 !== $.inArray(elementType, opts.supportsInputType) ||
                    ...
                    (el = elem, $el = $(el), !0 === opts.colorMask && initializeColorMask(el),
                        ...
                        (EventRuler.on(el, "submit", EventHandlers.submitEvent),
                            ...
                            EventRuler.on(el, "mouseleave", EventHandlers.mouseleaveEvent), !0 !== opts.colorMask &&
                            ...
                            android ||
                                ...
                                (EventRuler.on(el, "keydown", EventHandlers.keydownEvent),
                                    EventRuler.on(el, "keypress", EventHandlers.keypressEvent)), EventRuler.on(el,
                                "compositionstart",
                                $.noop),
                        ...
                        "" !== initialValue &&
                            checkVal(el, !0, !1, isRTL ? initialValue.split("").reverse() : initialValue.split(""));
                        var buffer = getBuffer().slice();
                        undoValue =
                                buffer.join(""), !1 === isComplete(buffer) && opts.clearIncomplete && resetMaskSet(),
                            opts.clearMaskOnLostFocus &&
                                document.activeElement !== el &&
    ...
    return Inputmask.prototype = {
        ...
        defaults: {
            ...
            ignorables: [
                8, 9, 13, 19, 27, 33, 34, 35, 36, 37, 38, 39, 40, 45, 46, 93, 112, 113, 114, 115, 116, 117, 118, 119,
                120, 121, 122, 123, 0, 229
            ],
            isComplete: null,
                    ...
                    function(ndx, el) {
                        ...
                        (el.inputmask !== undefined && el.inputmask.remove(), el.inputmask =
                            ...
                            el.inputmask.opts = scopedOpts, el.inputmask.noMasksCache =
                                that.noMasksCache, el.inputmask.userOptions = $.extend(!0, {}, that.userOptions),
        ...
        analyseMask: function(mask, regexMask, opts) {
            function MaskToken(isGroup, isOptional, isQuantifier, isAlternator) {
                this.matches = [], this.openGroup = isGroup || !1, this.alternatorGroup = !1, this.isGroup =
                        isGroup || !1,
                    this.isOptional = isOptional || !1, this.isQuantifier = isQuantifier || !1, this.isAlternator =
                        isAlternator || !1,
                    this.quantifier = {
                        min: 1,
                        max: 1
                ...
                maskToken &&
                    ...
                    $.each(maskToken.matches,
                        function(ndx, token) {
                            ...
                            (nextToken === undefined || nextToken.matches === undefined || !1 === nextToken.isQuantifier
                                    ) &&
                                    token &&
                                    token.isGroup &&
                                    (token.isGroup = !1,
                ...
                if (escaped) defaultCase();
                    ...
                    case opts.alternatormarker:
                        ...
                        if (lastMatch.isAlternator) openenings.push(lastMatch);
                                ...
                                : alternator = new MaskToken(!1, !1, !1, !0), alternator.matches.push(lastMatch),
