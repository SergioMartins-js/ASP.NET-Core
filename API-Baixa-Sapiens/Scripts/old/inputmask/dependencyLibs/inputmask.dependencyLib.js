...
!function(factory) {
    ...
    function isArraylike(obj) {
        ...
        return "function" !== ltype &&
            ...
            (!(1 !== obj.nodeType || !length) ||
                ("array" === ltype || 0 === length || "number" == typeof length && length > 0 && length - 1 in obj));
    }
    ...
    for (var class2type = {},
        ...
        nameNdx++) class2type["[object " + classTypes[nameNdx] + "]"] = classTypes[nameNdx].toLowerCase();
    return DependencyLib.prototype = {
        on: function(events, handler) {
            if (isValidElement(this[0]))
                for (var eventRegistry = this[0].eventRegistry, elem = this[0], _events = events.split(" "), endx = 0;
                    endx < _events.length;
                    endx++) {
                    ...
                    !function(ev, namespace) {
                        elem.addEventListener
                            ...
                            eventRegistry[ev] = eventRegistry[ev] || {}, eventRegistry[ev][namespace] =
        ...
        off: function(events, handler) {
            if (isValidElement(this[0]))
                for (var eventRegistry = this[0].eventRegistry, elem = this[0], _events = events.split(" "), endx = 0;
                    endx < _events.length;
                    endx++)
                    for (var nsEvent = _events[endx].split("."),
                        ...
                        !function(ev, namespace, handler) {
                            if (ev in eventRegistry == 1)
                                if (elem.removeEventListener
                                    ...
                                    eventRegistry[ev][namespace].splice(eventRegistry[ev][namespace].indexOf(handler),
                                        1);
        ...
        trigger: function(events) {
            if (isValidElement(this[0]))
                for (var eventRegistry = this[0].eventRegistry,
                    elem = this[0],
                    ...
                    if (void 0 !== document && "global" === namespace) {
                        ...
                        if (document.createEvent) {
                            try {
                                ...
                                evnt = document.createEvent("CustomEvent"), evnt.initCustomEvent(ev,
                                    params.bubbles,
                                    params.cancelable,
                                    params.detail);
                            }
                            ...
                            evnt = document.createEventObject(), evnt.eventType =
                                    ev, events.type && DependencyLib.extend(evnt, events),
    ...
    }, DependencyLib.noop = function() {}, DependencyLib.isArray = Array.isArray, DependencyLib.inArray =
        function(elem, arr, i) {
        ...
        if (isArray) for (; i < length; i++) null != (value = callback(elems[i], i)) && ret.push(value);
        ...
        if (document.createEvent)
            try {
                ...
                evnt = document.createEvent("CustomEvent"), evnt.initCustomEvent(event,
                    params.bubbles,
                    params.cancelable,
                    params.detail);
            }
