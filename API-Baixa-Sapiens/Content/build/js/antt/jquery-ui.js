...
//>>demos: http://jqueryui.com/widget/
    ...
    $.Widget.prototype = {
        ...
        _untrackClassesElement: function(event) {
            var that = this;
            $.each(that.classesElementLookup,
                function(key, value) {
        ...
        $.fn.position = function(options) {
            ...
            return this.each(function() {
                var collisionPosition,
                    ...
                    collisionWidth = elemWidth +
                        marginLeft +
                        parseCss(this, "marginRight") +
                        scrollInfo.width,
                    collisionHeight = elemHeight +
                        marginTop +
...
*/
    $.ui.ddmanager = {
        ...
        dragStart: function(draggable, event) {
            ...
            draggable.element.parentsUntil("body").on("scroll.droppable",
                function() {
...
//>>css.structure: ../../themes/base/selectable.css
    ...
    var widgetsSelectable = $.widget("ui.selectable",
        $.ui.mouse,
        {
            version: "1.12.1",
            options: {
    ...
    var widgetsSortable = $.widget("ui.sortable",
        $.ui.mouse,
        {
            ...
            refreshPositions: function(fast) {
                ...
                this.floating =
                    this.items.length ? this.options.axis === "x" || this._isFloating(this.items[0].item) : false;
    ...
    var widgetsAccordion = $.widget("ui.accordion",
        {
            ...
            _setOptionDisabled: function(value) {
                ...
                this._toggleClass(this.headers.add(this.headers.next()),
                    null,
                    "ui-state-disabled",
                    !!value);
            },
    ...
    var widgetsMenu = $.widget("ui.menu",
        {
            ...
            collapseAll: function(event, all) {
                ...
                this.timer = this._delay(function() {
                        ...
                        var currentMenu =
                            all ? this.element : $(event && event.target).closest(this.element.find(".ui-menu"));
            ...
            $.ui.formResetMixin, {
                ...
                _readType: function() {
                    ...
                    if (nodeName !== "input" || !/radio|checkbox/.test(this.type)) {
                        $.error("Can't create checkboxradio on element.nodeName=" +
                            nodeName +
                            " and element.type=" +
                            this.type);
                    }
    ...
    $.extend(Datepicker.prototype,
        {
            ...
            _connectDatepicker: function(target, inst) {
                ...
                input.addClass(this.markerClassName).on("keydown", this._doKeyDown).on("keypress", this._doKeyPress)
            ...
            _destroyDatepicker: function(target) {
                ...
                if (nodeName === "input") {
                    inst.append.remove();
                    inst.trigger.remove();
                    $target.removeClass(this.markerClassName).off("focus", this._showDatepicker)
                        .off("keydown", this._doKeyDown).off("keypress", this._doKeyPress).off("keyup", this._doKeyUp);
...
//>>css.theme: ../../themes/base/theme.css
    ...
    var widgetsSlider = $.widget("ui.slider",
        $.ui.mouse,
        {
            version: "1.12.1",
    ...
    $.widget("ui.tabs",
        {
            ...
            _processTabs: function() {
                ...
                this.tablist
                    .on("mousedown" + this.eventNamespace,
                        "> li",
                        function(event) {
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectBlind = $.effects.define("blind",
        "hide",
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectClip = $.effects.define("clip",
        "hide",
        function(options, done) {
            var start,
                animate = {},
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectDrop = $.effects.define("drop",
        "hide",
        function(options, done) {
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectExplode = $.effects.define("explode",
        "hide",
        function(options, done) {
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectFade = $.effects.define("fade",
        "toggle",
        function(options, done) {
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectFold = $.effects.define("fold",
        "hide",
        function(options, done) {
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectHighlight = $.effects.define("highlight",
        "show",
        function(options, done) {
            var element = $(this),
                animation = {
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectPuff = $.effects.define("puff",
        "hide",
        function(options, done) {
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectPulsate = $.effects.define("pulsate",
        "show",
        function(options, done) {
            var element = $(this),
                mode = options.mode,
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectSlide = $.effects.define("slide",
        "show",
        function(options, done) {
            var startClip,
                startRef,
